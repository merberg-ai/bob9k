...
class MotorController:
    """
    bob9k drive motor controller for the Adeept PiCar-B style PCA9685 HAT.

    This keeps the existing bob9k architecture intact, but uses the same
    ...
    forward/reverse. bob9k now does the same by default, while still exposing
