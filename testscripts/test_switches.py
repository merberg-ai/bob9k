from _common import refuse_if_service_running; from bob9k.config import load_config; from bob9k.logging_setup import setup_logging; from bob9k.hardware.switches import SwitchController; import time
